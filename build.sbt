...
// dependencies
libraryDependencies += "io.gatling" % "gatling-core" % "3.0.1" % "provided"
...
libraryDependencies += "io.gatling.highcharts" % "gatling-charts-highcharts" % "3.0.1" % "test"
libraryDependencies += "io.gatling"            % "gatling-test-framework"    % "3.0.1" % "test"
